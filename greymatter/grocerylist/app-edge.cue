...
let Name = "examples-grocerylist-edge"
...
AppEdge: {
    ...
    config: [
        ...
        #route & {
            ...
            rules: [{
                constraints: light: [
                    { cluster_key: "examples-apple", weight: 3 },
                    { cluster_key: "examples-banana", weight: 1 },
                    { cluster_key: "examples-lettuce", weight: 1 },
                    { cluster_key: "examples-tomato", weight: 1 }
                ]
            }]
		},

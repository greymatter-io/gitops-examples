...
// This package name refers to your target mesh. We are attempting to write configs for the "examples"
// Grey Matter mesh so the top level package is "examples". This does not need to match the cue module name.
package grocerylist
...
configs: grocerylist_config + core.Edge.config
